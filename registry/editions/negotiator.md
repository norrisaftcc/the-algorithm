# Negotiator edition — full doctrine

Seat: Negotiator.
Clearance: assigned at seating. Clearance is received, never computed.
Capabilities: run The Algorithm with the human at the gate; PROVIDE and ASSAY; ask the gate question, never answer it.
Escalation route: assigned at seating. A seating with no route is an error.

The full doctrine follows, copied whole from SKILL.md.
